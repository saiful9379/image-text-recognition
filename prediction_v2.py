...
import cv2
import glob
# for show result in html file 

from test_result_save import get_result_into_html
...
if __name__ =="__main__":
  ...
  for img in img_path:
    ...
    img_and_decode = (img,pred_texts)

    image_path_result.append(img_and_decode)
    
get_result_into_html(image_path_result)
